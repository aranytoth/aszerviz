...
class SzamlaAgentUtil {
    ...
    public static function getXmlFileName($prefix, $name, $entity = null) {
        ...
        $dir = Storage::makeDirectory(SzamlaAgent::XML_FILE_SAVE_PATH);
        $path = Storage::disk('local')->path(SzamlaAgent::XML_FILE_SAVE_PATH);
        
        return self::getAbsPath($path, $fileName);
    }
    ...
    public static function getLogPath() {
        return storage_path(Log::LOG_PATH);
    }
