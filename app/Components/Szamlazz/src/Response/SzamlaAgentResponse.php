...
class SzamlaAgentResponse {
    ...
    protected function getPdfFileAbsPath($pdfFileName) {
        Storage::makeDirectory(SzamlaAgent::PDF_FILE_SAVE_PATH);
        return Storage::disk('local')->path(SzamlaAgentUtil::getAbsPath(SzamlaAgent::PDF_FILE_SAVE_PATH, $pdfFileName));
    }
